export default function Products(){
    ...
    <div class="mx-auto max-w-2xl px-4  sm:px-6  lg:max-w-7xl lg:px-8">
      ...
      <div class="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8" id="">
        
        <a href="#" class="group" draggable="false">
          <div class="flex w-full overflow-hidden rounded-lg bg-gray-200 ">
            <canvas class="prod1"></canvas>
          </div>
          <h3 class="mt-4 text-sm text-gray-700">Shiba Inu Action Figure</h3>
          <p class="mt-1 text-lg font-medium text-gray-900">$48</p>
        </a>

        <a href="#" class="group" draggable="false">
          <div class="flex w-full overflow-hidden rounded-lg bg-gray-200 ">
            <canvas class="prod2"></canvas>
          </div>
          <h3 class="mt-4 text-sm text-gray-700">Shiba Inu Action Figure</h3>
          <p class="mt-1 text-lg font-medium text-gray-900">$48</p>
        </a>
